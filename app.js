...
// GET Sms
app.get('/smss', awaitHandler(async (req, res) => {
	logger.info('================ GET on sms');
	let args = {};
	let fcn = "queryAllSms";

    logger.info('##### GET on Sms - username : ' + username);
	logger.info('##### GET on Sms - userOrg : ' + orgName);
	logger.info('##### GET on Sms - channelName : ' + channelName);
	logger.info('##### GET on Sms - chaincodeName : ' + chaincodeName);
	logger.info('##### GET on Sms - fcn : ' + fcn);
	logger.info('##### GET on Sms - args : ' + JSON.stringify(args));
	logger.info('##### GET on Sms - peers : ' + peers);
...
// GET a specific Sms?
app.get('/smss/:smsKey', awaitHandler(async (req, res) => {
	logger.info('================ GET on Sms by SmsKey');
...
// POST Sms
app.post('/smss', awaitHandler(async (req, res) => {
	logger.info('================ POST on Sms');
	var args = req.body;
	var fcn = "createSms";

    logger.info('##### POST on Sms - username : ' + username);
	logger.info('##### POST on Sms - userOrg : ' + orgName);
	logger.info('##### POST on Sms - channelName : ' + channelName);
	logger.info('##### POST on Sms - chaincodeName : ' + chaincodeName);
	logger.info('##### POST on Sms - fcn : ' + fcn);
	logger.info('##### POST on Sms - args : ' + JSON.stringify(args));
	logger.info('##### POST on Sms - peers : ' + peers);
